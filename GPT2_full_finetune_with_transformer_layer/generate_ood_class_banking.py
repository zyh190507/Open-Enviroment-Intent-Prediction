...
from GPT2_full_finetune_with_transformer_layer.pipe import Data
...
class GenerateOOD:
    ...
    def load_glove_embed(self) -> dict:
...
if __name__ == '__main__':
    from GPT2_full_finetune_with_transformer_layer.utils import load_parameters, get_unkdataset_of_dataset
    from GPT2_full_finetune_with_transformer_layer.pipe import set_seed
    ...
    unkDs = "unkdataset_with_noise/unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}.pkl".format(
        args.dataset, args.known_cls_ratio, args.seed, args.lr)
    pretrain_model_path = Model(args)
    tokenizer_path = data.tokenizer
    args.p_node = 0.2
    # for rama_cluster_times in range(3):
    # for times in range(5, 20):
    gen_ood = GenerateOOD(args, data, unkDs, pretrain_model_path, tokenizer_path, rama_cluster_times=5)
