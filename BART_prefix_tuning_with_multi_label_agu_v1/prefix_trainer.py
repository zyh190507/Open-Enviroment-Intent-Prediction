...
from BART_prefix_tuning_with_multi_label_agu_v1.metric import RougeMetric
...
if __name__ == '__main__':
    ...
    log_dir = "log/dataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-lmd-{}".format(
        args.dataset, args.known_cls_ratio,
        args.seed, args.lr, args.pre_seq_len, args.lamda_loss)
    ...
    for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        # eval_score = average_precision_score(y_label, y_pred)
        # eval_score = -hamming_loss(y_label, y_pred)
        pred = np.rint(y_pred)
