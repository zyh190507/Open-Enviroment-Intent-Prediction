...
from BART_prefix_tuning_with_multi_label_agu_v1.base import PushToHubFriendlyModel, BARTClassificationHead
from BART_prefix_tuning_with_multi_label_agu_v1.modeling_bart import BartForConditionalGeneration
...
class Model(PushToHubFriendlyModel):
    ...
    def evaluate_step(self,
        ...
        generate_tokens = self.generate(input_ids=input_ids,
                                        ...
                                        num_beams=3, output_scores=True, max_length=decoder_input_ids.shape[1] + 10,
        ...
        result.update(self.forward(input_ids=input_ids, attention_mask=attention_mask, labels=labels))
        return result
