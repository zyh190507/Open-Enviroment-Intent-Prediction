...
from BART_full_finetune.metric import BoundaryLoss, F_measure, euclidean_metric
...
class ModelManager:
    ...
    def evaluation(self, args, data, mode="eval"):
        ...
        if mode == 'eval':
            ...
            unk_path = "unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-lmd-{}-delta-{}.pkl".format(
    ...
    def save_results(self, args):
        ...
        file_name = '{}_results.csv'.format(args.dataset)
