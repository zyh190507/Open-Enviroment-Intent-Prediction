...
from T5_prefix_tuning_with_multi_label_v2.metric import Accuracy, BoundaryLoss, F_measure, euclidean_metric
...
class ModelManager:
    ...
    def evaluation(self, args, data, mode="eval"):
        ...
        if mode == 'eval':
            ...
            unk_path = "unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-lmd-{}.pkl".format(
            ...
            for step, batch in enumerate(tqdm(data.train_dataloader, desc="Iteration")):
                ...
                with torch.set_grad_enabled(True):
                    features = self.model(input_ids=input_ids, attention_mask=input_mask,
                                          labels=labels, multi_labels=None)['feature']
