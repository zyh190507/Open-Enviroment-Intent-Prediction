...
class GenerateOOD:
    ...
    def __init__(self, args, data, unkdataset_or_filename, pretrain_model_or_path, tokenizer_or_path,
    ...
    def _generate_utterance(self):
        ...
        arg = self.args
        pickle_name = "dataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-lmd-{}-m-loss-{}".format(
...
if __name__ == '__main__':
    from GPT2_prefix_tuning_with_multi_label_v2.utils import load_parameters, get_unkdataset_of_dataset
    from GPT2_prefix_tuning_with_multi_label_v2.pipe import set_seed, Pipe
    ...
    unkDs = "unkdataset_with_noise/unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-lmd-{}-m-loss-{}.pkl".format(
                args.dataset, args.known_cls_ratio,
                args.seed, args.lr, args.pre_seq_len, args.lamda_loss, args.m_loss)
