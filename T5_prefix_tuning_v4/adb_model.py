...
from T5_prefix_tuning_v4.pipe import Data, set_seed
from T5_prefix_tuning_v4.metric import Accuracy, BoundaryLoss, F_measure, euclidean_metric
...
class ModelManager:
    ...
    def evaluation(self, args, data, mode="eval"):
        ...
        if mode == 'eval':
            ...
            unk_path = "unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-prefix_projection-{}" \
            ...
            for step, batch in enumerate(tqdm(data.train_dataloader, desc="Iteration")):
                ...
                with torch.set_grad_enabled(True):
                    features = self.model(input_ids=input_ids, attention_mask=input_mask,
                                          labels=labels, label_ids=None)['feature']
    ...
    def save_results(self, args):
        ...
        var = [args.dataset, args.known_cls_ratio, args.labeled_ratio, args.seed, args.pre_seq_len, args.lr]
        names = ['dataset', 'known_cls_ratio', 'labeled_ratio', 'seed', 'psl', 'lr']
