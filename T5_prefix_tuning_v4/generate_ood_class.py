...
from T5_prefix_tuning_v4.pipe import Data
...
class GenerateOOD:
    ...
    def _generate_utterance(self):
        ...
        pickle_name = "dataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-prefix_projection-{}" \
                      "-prefix_hidden_size-{}-prefix_dropout-{}-train_batch_size-{}_v1".format(
...
if __name__ == '__main__':
    from T5_prefix_tuning_v4.utils import load_parameters
    from T5_prefix_tuning_v4.pipe import set_seed
    from T5_prefix_tuning_v4.prefixtuning import Model
    ...
    unkDs = "unkdataset_with_noise/unkdataset-{}-known_cls_ratio-{}-seed-{}-lr-{}-pre_seq_len-{}-prefix_projection-{}" \
            "-prefix_hidden_size-{}-prefix_dropout-{}-train_batch_size-{}.pkl".format(
        args.dataset, args.known_cls_ratio,
        args.seed, args.lr, args.pre_seq_len, args.prefix_projection, args.prefix_hidden_size, args.prefix_dropout,
        args.train_batch_size)
